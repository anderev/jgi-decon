var staging = {
  install_location: '/global/projectb/sandbox/omics/sc-decontamination/Production/scd-1.3.3',
  ...
  scd_exe: 'qsub -N JOBNAME -j y -R y -V -o LOGFILE -l h_rt=12:00:00 -l ram.c=48G -pe pe_slots 8 /global/projectb/sandbox/omics/sc-decontamination/Production/scd-1.3.3/bin/scd.sh',
